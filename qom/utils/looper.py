...
def get_looper_func(SystemClass, solver_params: dict, func_code: str):
    ...
    def func_averaged_eigenvalues(system_params, val, logger, results):
        ...
        aes = system.get_averaged_eigenvalues(solver_params=solver_params, func_ode=system.func_ode, get_ivc=system.get_ivc, get_A=system.get_A)
        # update results
    ...
    def func_measure_average(system_params, val, logger, results):
        ...
        system = SystemClass(system_params)
        # get measure average
        mav = system.get_measure_average(solver_params=solver_params, func_ode=system.func_ode, get_ivc=system.get_ivc, get_A=system.get_A)
        # update results
    ...
    def func_measure_dynamics(system_params, val, logger, results):
        ...
        mdy, _ = system.get_measure_dynamics(solver_params=solver_params, func_ode=system.func_ode, get_ivc=system.get_ivc, get_A=system.get_A)
        # update results
    ...
    def func_lyapunov_exponents(system_params, val, logger, results):
        ...
        les = system.get_lyapunov_exponents(solver_params=solver_params, get_mode_rates=system.get_mode_rates, get_ivc=system.get_ivc, get_A=system.get_A)
        # update results
    ...
    def func_pearson_correlation_coefficient(system_params, val, logger, results):
        ...
        pcc = system.get_pearson_correlation_coefficient(solver_params=solver_params, func_ode=system.func_ode, get_ivc=system.get_ivc)
        # update results
...
def wrap_looper(SystemClass, params: dict, func, looper, file_path: str=None, plot: bool=False, hold: bool=True, width: float=5.0, height: float=5.0):
    ...
    if type(func) is str:
        func = get_looper_func(SystemClass, params, func)
